 ...
 * @author gram1
 */
public class SuppliersMGMT extends javax.swing.JFrame {

   int xx=0;
int yy=0;
    public SuppliersMGMT() {
        initComponents();
        refresh_JTable();
         setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Supplied ID");
        jLabel4.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N

        jLabel3.setText("Supplied Name");
        jLabel3.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N

        jLabel6.setText("Supplied Contact");
        jLabel6.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N

        jLabel5.setText("Supplied Address");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Supplied Name", "Suppliers Contact", "Supplied Address", "Supplied City"
            }
        ) {
    ...
    private void save_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_btnActionPerformed
           ...
           !jTextField5.getText().trim().isEmpty())
     {
			...
			String sup_contact= jTextField3.getText().trim(); 
			String sup_address= jTextField4.getText().trim();
			String sup_city= jTextField5.getText().trim();
        ...
        if (found) {
             // New Product Record  
             AddFunctions.add_suppliers(sup_id, sup_name, sup_contact, sup_address, sup_city);
             JOptionPane.showMessageDialog(null, "NEW Suppliers Record Successfully ADDED!");
           } else {
             // found is true! So existing student recort will be updated!!!  
             EditFunctions.edit_suppliers(sup_id, sup_name, sup_contact, sup_address, sup_city);
             JOptionPane.showMessageDialog(null, "Suppliers Record Successfully EDITED!");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        List supplierses =BakeryManagementSystemProject.supplierses;
        Suppliers su;
        su = (Suppliers) supplierses.get(sel_row);
        jTextField1.setText(""+su.getSup_id());
        jTextField2.setText(su.getSup_name());
        jTextField3.setText(su.getSup_contact());   
        jTextField4.setText(su.getSup_address());   
        jTextField5.setText(su.getSup_city());   
    ...
    private void del_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_del_btnActionPerformed
	  ...
	  Suppliers su = null;
        ...
        if (found) {
             DelFunctions.delete_suppliers(sup_id);
             JOptionPane.showMessageDialog(null, "Selected Suppliers Record Successfully DELETED!");
           } 
    } else                                      
       {
            JOptionPane.showMessageDialog(null, "You have to fill Suppliers id field before deleting the record!");
        }
        refresh_JTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuppliersMGMT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SuppliersMGMT().setVisible(true);
            }
        });
    }
// Reflesh Table============================
public void refresh_JTable() {    
           ...
           Iterator itr = supplierses.iterator();
           Suppliers su;          
           model.setNumRows(0); 
           while (itr.hasNext()) {
              su = (Suppliers) itr.next();
              rowData[0] = su.getSup_id();
              rowData[1] = su.getSup_name();
              rowData[2] = su.getSup_contact();
              rowData[3] = su.getSup_address();
              rowData[4] = su.getSup_city();
